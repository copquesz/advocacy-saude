    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto align-items-center">
          ...
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#noticias">Noticias</a> </li>
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">Contato</a> </li>
          <li class="nav-item mb-0">
            <button type='button' class="btn btn-primary pr-5 pl-5" data-toggle="modal" data-target="#popUpWindow">
              Entrar
            </button>
          </li>
        </ul>
        ...
        <div class="wrapper fadeInDown">
          <div id="formContent">
            ...
            <div class="fadeIn first">
              <img src="img/img-custom/icon-user.jpg" id="icon" alt="User Icon" />
            </div>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="img/img-slide/Slide2.JPG" alt="Third slide">
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="img/img-slide/Slide6.JPG" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
              <div class="intro-text">
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="img/img-slide/Slide4.JPG" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
              <div class="intro-text">
                <div class="display-4 text-dark"
                  style="background-color: rgba(255, 225, 127, 0.596); border-radius: 15px 50px;">
      ...
      <div class="row ">
        ...
        <div class="col-sm-12 col-md-7 align-self-center ">
          <div class=" wow animated rollIn">
            ...
            <img class="img-fluid rounded-circle" src="img/img-slide/Slide5.JPG" alt="" wight>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-lg-8">
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100 rounded" src="img/img-slide/Slide9.JPG" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100 rounded" src="img/img-slide/Slide2.JPG" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100 rounded" src="img/img-slide/Slide6.JPG" alt="Third slide">
              </div>
            </div>
          ...
          <div class="row py-1">
            <div class="col-sm-4 col-md-4 py-1">
              <img src="img/img-slide/Slide4.JPG" alt="" class="img-fluid rounded">
            </div>
            <div class="col-sm-4 col-md-4 py-1">
              <img src="img/img-slide/Slide7.JPG" alt="" class="img-fluid rounded">
            </div>
            <div class="col-sm-4 col-md-4 py-1">
              <img src="img/img-slide/Slide5.JPG" alt="" class="img-fluid rounded">
            </div>
          </div>
          ...
          <ul class="timeline">
            <li>
              <div class="timeline-image">
                <img class="pt-3  img-fluid" src="img/img-timeline/1.svg" width="130" height="130">
              </div>
            ...
            <li class="timeline-inverted">
              <div class="timeline-image">
                <img class="pt-3 img-fluid" src="img/img-timeline/2.svg" width="110" height="110">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>2° passo</h4>
