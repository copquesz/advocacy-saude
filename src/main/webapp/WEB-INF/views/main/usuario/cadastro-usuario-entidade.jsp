  ...
  <body>
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 py-3 order-2" style="background-image: linear-gradient(rgba(1, 163, 164, 1), rgba(254, 202, 87, 1));">

          <div class="text-center">
            <h2 class="text-light bg-default p-4" style="border-bottom: 2.5px solid #fff;"><i class="fas fa-user-plus fa-2x mr-2"></i> Cadastro de Pessoa Jurídica</h2>
          </div>
          ...
          <c:if test = "${emailCadastrado}">
            <div class="alert alert-danger my-3" role="alert">
              ...
              <p>O e-mail <strong>${usuarioEntidade.email}</strong> já está cadastrado em nossa plataforma</strong>.</p>
              <hr>
          ...
          <c:if test = "${cnpjCadastrado}">
            <div class="alert alert-danger my-3" role="alert">
              <h4 class="alert-heading">Falha!</h4>
              <p>O CPF <strong>${usuarioEntidade.cnpj}</strong> já está cadastrado em nossa plataforma</strong>.</p>
              <hr>
          ...
          <c:if test = "${cadastrado}">
            <div class="alert alert-success my-3" role="alert">
              ...
              <p>Olá <strong>${usuarioEntidade.nomeFantasia}</strong>! Seu cadastro foi realizado com suceso em nossa plataforma.</p>
              <hr>
          ...
          <div class="row">
            <div class="col-12">
              <form action="${path}/usuario/cadastro/pessoa-juridica" method="post" acceptcharset="UTF-8">
                <input type="hidden" name="tipo" value="USUARIO_PJ">
                <fieldset class="mt-3">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nome-fantasia" name="nomeFantasia" placeholder="" required>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="razao-social">Razão Social:</label>
                        <input type="text" class="form-control" id="razao-social" name="razaoSocial" placeholder="" required>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="cnpj">CNPJ:</label>
                        <input type="text" class="form-control" id="cnpj" name="cnpj" placeholder="" required onchange="if(!validarCNPJ(this.value)){alert('CNPJ INVÁLIDO'); this.value='';}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control">
                          <c:forEach var="patologia" items="${patologias}">
                            <optgroup label="${patologia.nome}">
                              <c:forEach var="subpatologia" items="${patologia.subpatologias}">
                                <option value="${subpatologia.id}">${subpatologia.nome}</option>
                              </c:forEach>
                            </optgroup>                              
                          </c:forEach>    
                        </select> 
        ...
        <div class="col-lg-6 order-1" style="background: url(${path}/img/bg-cadastro-pessoa-juridica.jpg), linear-gradient(rgba(1, 163, 164, 0.5), rgba(254, 202, 87, 0.5)); background-size: contain; background-attachment: fixed; border-bottom-left-radius: 50%; border-top-left-radius: 15%;></div>
      </div><!-- /ROW -->      
