                      ...
                      <!-- COLUNA ESQUERDA -->
                        <div class="col-md-6">
                            ...
                            <div class="form-group py-2">
                                <label class="btn-bs-file btn btn-lg btn-secondary">Carregar Imagem<input type="file" id="input-file-img-banner" name="banner.arquivo" /></label>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="introducao" placeholder="Escreva uma introdução para a notícia ..." rows="4" maxlength="300" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
