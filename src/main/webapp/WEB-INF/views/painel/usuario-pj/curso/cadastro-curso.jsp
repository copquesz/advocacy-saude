          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">              
              ...
              <div class="card-body border">                
                <form class="forms-sample" action="${path}/painel/curso/cadastro" method="post" acceptcharset="UTF-8" enctype="multipart/form-data">                  
                  <div class="row ">
                     <!-- INFOS CURSO -->
                    <div class="col-md-6">
                      <div class="row">    
                      ...
                      <div class="row">    
                        <div class="col-md-12"> 
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="introducao" placeholder="Escreva aqui uma breve introdução sobre o curso ... " rows="13" maxlength="360" required></textarea>
                          </div>  
                        </div> 
                      </div> 
                      <div class="row mt-5">
